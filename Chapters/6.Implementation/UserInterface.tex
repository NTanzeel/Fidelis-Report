...
\begin{subfigure}[b]{0.5\linewidth}
	\includegraphics[width=1\textwidth]{Images/Implementation/UI/Widgets/Profile_Self}
	\caption{}
	\label{fig:UserNavigation}
\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}
	\includegraphics[width=1\textwidth]{Images/Implementation/UI/Widgets/Profile_Other}
	\caption{}
	\label{fig:AppNavigation}
\end{subfigure}
\caption{Rendering options for (a) user and (b) application navigation}

...
\subsection{Widgets}
Widgets are ``miniature application views'' that are re-usable and specified, limited functionality \cite{AndroidDevelopers:Widgets}. Widgets are extremely popular on mobile devices; in figure \ref{fig:WeatherWidget} we can see a widget for the weather. 
